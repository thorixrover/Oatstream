        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="max-w-md p-8">
            ...
            <div className="text-center space-y-3 mt-6">
              <h2 className="text-xl font-semibold">Terhubunglah dengan partner yang ada di seluruh dunia</h2>
              <p className="opacity-70">
                Berlatih percakapan, menjalin pertemanan, dan tingkatkan kemampuan bahasa Anda bersama-sama.
              </p>
            </div>
          </div>
        </div>
